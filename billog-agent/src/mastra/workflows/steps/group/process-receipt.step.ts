/**
 * Group Process Receipt Step
 *
 * Processes receipt images for group expenses using OCR.
 * Preserves receipt currency and allows split handling.
 *
 * Input: Image URL or base64
 * Output: Parsed expense data from OCR (ready for split)
 */
...
export const groupProcessReceiptStep = createStep({
